...
def add_medication():
    ...
    try:
        ...
        required_fields = ['user_id', 'medication_name', 'dosage', 'frequency', 'times']
        ...
        medication = {
            ...
            'days_of_week': data.get('days_of_week', [0, 1, 2, 3, 4, 5, 6]),  # Default: all days
        ...
        # Insert medication
        result = mongo.db.medication_schedules.insert_one(medication)
